...
developers := List(
  Developer(
    ...
    url = url("https://github.com/zoho/zohocrm-scala-sdk-6.0")
  )
)
crossPaths := false
pomExtra :=
  <url>https://github.com/zoho/zohocrm-scala-sdk-6.0</url>
    <scm>
      <url>https://github.com/zoho/zohocrm-scala-sdk-6.0</url>
      <connection>scm:git:git@github.com:zoho/zohocrm-scala-sdk-6.0</connection>
    </scm>
licenses := Seq(
