...
class RolesOperations	{
	...
	def getRole( roleId: Long) :Option[APIResponse[ResponseHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v6/settings/roles/")
	...
	def updateRole( roleId: Long,  request: BodyWrapper) :Option[APIResponse[ActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v6/settings/roles/")
		apiPath = apiPath.concat(roleId.toString())
	...
	def deleteRole( roleId: Long,  paramInstance: Option[ParameterMap]=None) :Option[APIResponse[ActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v6/settings/roles/")
		apiPath = apiPath.concat(roleId.toString())
 ...
 object RolesOperations{
class DeleteRoleParam		{
		final val transferToId:Param[Long] = new Param[Long]("transfer_to_id", "com.zoho.crm.api.Roles.DeleteRoleParam")
	}
}
