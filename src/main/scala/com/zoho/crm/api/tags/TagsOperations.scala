...
class TagsOperations	{
	...
	def addTags( recordId: Long,  moduleAPIName: String,  request: NewTagRequestWrapper,  paramInstance: Option[ParameterMap]=None) :Option[APIResponse[RecordActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
	...
	def removeTags( recordId: Long,  moduleAPIName: String,  request: ExistingTagRequestWrapper) :Option[APIResponse[RecordActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v6/")
		apiPath = apiPath.concat(moduleAPIName.toString())
