...
class Users extends Record with Model	{
	...
	def getPhone() :Option[Long]	={
		return  this.getKeyValue("phone").asInstanceOf[Option[Long]]
	}

	def setPhone( phone: Option[Long]) 	={
	...
	def getMobile() :Option[Long]	={
		return  this.getKeyValue("mobile").asInstanceOf[Option[Long]]
	}

	def setMobile( mobile: Option[Long]) 	={
