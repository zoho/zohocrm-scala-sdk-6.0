...
class ModuleFields extends Fields with Model	{
	...
	private var autoNumber64:Option[AutoNumber] = None
	...
	def getAutoNumber64() :Option[AutoNumber]	={
		return  this.autoNumber64
	}

	def setAutoNumber64( autoNumber64: Option[AutoNumber]) 	={
