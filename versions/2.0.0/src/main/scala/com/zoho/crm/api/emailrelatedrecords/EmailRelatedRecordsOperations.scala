...
class EmailRelatedRecordsOperations(var recordId: Long, var moduleName: String)	{
...
class GetEmailsRelatedRecordsParam		{
		final val type1:Param[Choice[String]] = new Param[Choice[String]]("type", "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordsParam")
		...
		final val ownerId:Param[Long] = new Param[Long]("owner_id", "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordsParam")
	}
}
